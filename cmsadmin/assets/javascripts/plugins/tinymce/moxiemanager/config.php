<?php
	// General
	$moxieManagerConfig['general.license'] = 'L6QN-IN73-QULU-OFEM-QJ52-OEVR-VFOB-7G6F';
	...
	// Filesystem
	$moxieManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'] . '/assets/img/';
	...
	$moxieManagerConfig['SessionAuthenticator.logged_in_key'] = 'admin_user_id';
	...
	// 		'user' => '',
	// 		'password' => '',
	// 		'rootpath' => '/var/www/tritoncptl.com/',
	// 		'wwwroot' => '/var/www/tritoncptl.com/public_html/',
	// 		'passive' => true
	// 	)
	// );
    ...
    // if (awsEnabled === false) {
    //     $moxieManagerConfig['general.plugins'] .= ',AmazonS3';
    //     $moxieManagerConfig['filesystem.rootpath'] = 's3://'.awsBucketName.'/'.FOLDER_FILES.'/';
    //     // Amazon S3 plugin
    //     $moxieManagerConfig['amazons3.buckets'] = array(
    //         awsBucketName => array(
    //             'urlprefix' => 'https://s3-us-west-1.amazonaws.com/',
