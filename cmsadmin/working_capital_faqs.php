...
if (!empty($_GET['delete'])) {
    $db->query("delete from working_capital_faqs where id = ".(int)$_GET['delete']." limit 1");
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    <div class='box-content'>
                      <a class="btn btn-success" href="working_capital_faq_edit.php"><i class='icon-plus-sign'></i> Add new Working Capital FAQ</a>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="box bordered-box purple-border no-bottom-margin">
                    <div class="box-content box-no-padding">
                      <table class="table table-striped no-bottom-margin">
                        ...
                        <tbody>
                          <?php foreach ($db->query("select * from working_capital_faqs order by question") as $faq) { ?>
                            <tr>
                              ...
                              <td>
                                <div class="text-right">
                                  <a class="btn btn-success btn-xs" href="working_capital_faq_edit.php?id=<?php echo $faq['id']; ?>">
                                    <i class="icon-edit"></i>
                                  </a>
