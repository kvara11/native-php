    ...
    <footer class="footer">
        ...
        <div class="clear wrapper">
            <div class="copyright-info">
                &copy; <?php echo date('Y'); ?> Copyright Triton Capital | CFLL No. 60DBO42128 
            </div>
        </div>
    ...
    <script src="/<?php echo FOLDER_ASSETS; ?>/js/plugins.js?v=05042017"></script>
    <script>
        var base_url = '<?=APPLY_BASE_URL?>';
    </script>
    <script src="/<?php echo FOLDER_ASSETS; ?>/js/main.js?v=07252017"></script>
    <script src="/<?php echo FOLDER_ASSETS; ?>/js/global-functions.min.js?v=07252017"></script>
    <script>
    ...
    <script src="/<?php echo FOLDER_ASSETS; ?>/js/jquery.scrollTo.min.js"></script>
