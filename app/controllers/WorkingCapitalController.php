...
class WorkingCapitalController extends BaseController
{
    ...
    public function showLoanLanding($params)
    {
        ...
        $landing_page = $db->prepare("SELECT * FROM landing_pages WHERE url_slug = :slug and parent = 1");
        ...
        $app->template->render('loan-landing-wc.php');
    ...
    public function showLanding()
    {
        ...
        $app->template->render('working-capital.php');
    }
